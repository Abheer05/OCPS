<?php 
    ...
    if(isset($_GET['company'])){
        ...
        header("Location: view_company.php?msg=$msg");


    }
    else if(isset($_GET['coord'])){
        $id = $_GET['id'];
        $delete = $fun->deleteCoord( $id );
        if($delete){
            $msg = "Deleted";   
        }
        else{
        ...
        header("Location: view_coord.php?msg=$msg");
