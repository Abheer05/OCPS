<?php 
  ...
  if(isset( $_POST['submit'] )){
    ...
    if($department == '' || $sec == '' || $sem == ''){
      ...
      $fetch = $fun->addSection($department, $sec, $sem);
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <section class="section">
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Section Form</h5>
              <?php 
                  if(isset($_POST['submit'])){
                ?>
                ...
                ?>
              <!-- No Labels Form -->
              <form class="row g-3"  action="add_section.php" method="POST">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <input type="text" class="form-control" id="sec" name="sec" placeholder="Section">
                </div>
                <div class="col-md-6">
